                ...
                <div
                        ...
                        <form wire:submit="save" class="space-y-4">
                            <div class="gap-4 grid grid-cols-1 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="code" wire:model="code"
                                        {{ $editMode ? '' : 'readonly' }}
                                        class="mt-1 block w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 {{ $editMode ? '' : 'opacity-70' }}">
                                    @error('code')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div>
                                ...
                                <textarea id="description" wire:model="description" rows="3"
                                    class="block bg-gray-700 mt-1 px-3 py-2 border border-gray-600 focus:border-cyan-500 rounded-md focus:outline-none focus:ring-cyan-500 w-full text-white"></textarea>
                                @error('description')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="flex items-center">
                                <input id="is_active" type="checkbox" wire:model="is_active"
                                    class="bg-gray-700 border-gray-600 rounded focus:ring-cyan-500 w-4 h-4 text-cyan-500">
                    ...
                    <div class="sm:flex sm:flex-row-reverse bg-gray-700 px-4 sm:px-6 py-3">
                        <button wire:click="save" type="button"
                            class="inline-flex justify-center bg-cyan-500 hover:bg-cyan-600 shadow-sm sm:ml-3 px-4 py-2 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 w-full sm:w-auto font-medium text-white sm:text-sm text-base">
