        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-indigo-50: oklch(.971 .013 17.38);
                    --color-indigo-100: oklch(.936 .032 17.717);
                    --color-indigo-200: oklch(.885 .062 18.334);
                    --color-indigo-300: oklch(.808 .114 19.571);
                    --color-indigo-400: oklch(.704 .191 22.216);
                    --color-indigo-500: oklch(.637 .237 25.331);
                    --color-indigo-600: oklch(.577 .245 27.325);
                    --color-indigo-700: oklch(.505 .213 27.518);
                    --color-indigo-800: oklch(.444 .177 26.899);
                    --color-indigo-900: oklch(.396 .141 25.723);
                    --color-indigo-950: oklch(.258 .092 26.042);
                    ...
                    --color-indigo-50: oklch(.986 .031 120.757);
                    --color-indigo-100: oklch(.967 .067 122.328);
                    --color-indigo-200: oklch(.938 .127 124.321);
                    --color-indigo-300: oklch(.897 .196 126.665);
                    --color-indigo-400: oklch(.841 .238 128.85);
                    --color-indigo-500: oklch(.768 .233 130.85);
                    --color-indigo-600: oklch(.648 .2 131.684);
                    --color-indigo-700: oklch(.532 .157 131.589);
                    --color-indigo-800: oklch(.453 .124 130.933);
                    --color-indigo-900: oklch(.405 .101 131.063);
                    --color-indigo-950: oklch(.274 .072 132.109);
                    --color-indigo-50: oklch(.982 .018 155.826);
                    --color-indigo-100: oklch(.962 .044 156.743);
                    --color-indigo-200: oklch(.925 .084 155.995);
                    --color-indigo-300: oklch(.871 .15 154.449);
                    --color-indigo-400: oklch(.792 .209 151.711);
                    --color-indigo-500: oklch(.723 .219 149.579);
                    --color-indigo-600: oklch(.627 .194 149.214);
                    --color-indigo-700: oklch(.527 .154 150.069);
                    --color-indigo-800: oklch(.448 .119 151.328);
                    --color-indigo-900: oklch(.393 .095 152.535);
                    --color-indigo-950: oklch(.266 .065 152.934);
                    ...
                    --color-indigo-50: oklch(.977 .014 308.299);
                    --color-indigo-100: oklch(.946 .033 307.174);
                    --color-indigo-200: oklch(.902 .063 306.703);
                    --color-indigo-300: oklch(.827 .119 306.383);
                    --color-indigo-400: oklch(.714 .203 305.504);
                    --color-indigo-500: oklch(.627 .265 303.9);
                    --color-indigo-600: oklch(.558 .288 302.321);
                    --color-indigo-700: oklch(.496 .265 301.924);
                    --color-indigo-800: oklch(.438 .218 303.724);
                    --color-indigo-900: oklch(.381 .176 304.987);
                    --color-indigo-950: oklch(.291 .149 302.717);
