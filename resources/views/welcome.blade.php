        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-lime-50: oklch(.971 .013 17.38);
                    --color-lime-100: oklch(.936 .032 17.717);
                    --color-lime-200: oklch(.885 .062 18.334);
                    --color-lime-300: oklch(.808 .114 19.571);
                    --color-lime-400: oklch(.704 .191 22.216);
                    --color-lime-500: oklch(.637 .237 25.331);
                    --color-lime-600: oklch(.577 .245 27.325);
                    --color-lime-700: oklch(.505 .213 27.518);
                    --color-lime-800: oklch(.444 .177 26.899);
                    --color-lime-900: oklch(.396 .141 25.723);
                    --color-lime-950: oklch(.258 .092 26.042);
