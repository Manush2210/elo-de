        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-teal-50: oklch(.971 .013 17.38);
                    --color-teal-100: oklch(.936 .032 17.717);
                    --color-teal-200: oklch(.885 .062 18.334);
                    --color-teal-300: oklch(.808 .114 19.571);
                    --color-teal-400: oklch(.704 .191 22.216);
                    --color-teal-500: oklch(.637 .237 25.331);
                    --color-teal-600: oklch(.577 .245 27.325);
                    --color-teal-700: oklch(.505 .213 27.518);
                    --color-teal-800: oklch(.444 .177 26.899);
                    --color-teal-900: oklch(.396 .141 25.723);
                    --color-teal-950: oklch(.258 .092 26.042);
                    ...
                    --color-teal-50: oklch(.986 .031 120.757);
                    --color-teal-100: oklch(.967 .067 122.328);
                    --color-teal-200: oklch(.938 .127 124.321);
                    --color-teal-300: oklch(.897 .196 126.665);
                    --color-teal-400: oklch(.841 .238 128.85);
                    --color-teal-500: oklch(.768 .233 130.85);
                    --color-teal-600: oklch(.648 .2 131.684);
                    --color-teal-700: oklch(.532 .157 131.589);
                    --color-teal-800: oklch(.453 .124 130.933);
                    --color-teal-900: oklch(.405 .101 131.063);
                    --color-teal-950: oklch(.274 .072 132.109);
                    --color-teal-50: oklch(.982 .018 155.826);
                    --color-teal-100: oklch(.962 .044 156.743);
                    --color-teal-200: oklch(.925 .084 155.995);
                    --color-teal-300: oklch(.871 .15 154.449);
                    --color-teal-400: oklch(.792 .209 151.711);
                    --color-teal-500: oklch(.723 .219 149.579);
                    --color-teal-600: oklch(.627 .194 149.214);
                    --color-teal-700: oklch(.527 .154 150.069);
                    --color-teal-800: oklch(.448 .119 151.328);
                    --color-teal-900: oklch(.393 .095 152.535);
                    --color-teal-950: oklch(.266 .065 152.934);
                    ...
                    --color-teal-50: oklch(.962 .018 272.314);
                    --color-teal-100: oklch(.93 .034 272.788);
                    --color-teal-200: oklch(.87 .065 274.039);
                    --color-teal-300: oklch(.785 .115 274.713);
                    --color-teal-400: oklch(.673 .182 276.935);
                    --color-teal-500: oklch(.585 .233 277.117);
                    --color-teal-600: oklch(.511 .262 276.966);
                    --color-teal-700: oklch(.457 .24 277.023);
                    --color-teal-800: oklch(.398 .195 277.366);
                    --color-teal-900: oklch(.359 .144 278.697);
                    --color-teal-950: oklch(.257 .09 281.288);
                    ...
                    --color-teal-50: oklch(.977 .014 308.299);
                    --color-teal-100: oklch(.946 .033 307.174);
                    --color-teal-200: oklch(.902 .063 306.703);
                    --color-teal-300: oklch(.827 .119 306.383);
                    --color-teal-400: oklch(.714 .203 305.504);
                    --color-teal-500: oklch(.627 .265 303.9);
                    --color-teal-600: oklch(.558 .288 302.321);
                    --color-teal-700: oklch(.496 .265 301.924);
                    --color-teal-800: oklch(.438 .218 303.724);
                    --color-teal-900: oklch(.381 .176 304.987);
                    --color-teal-950: oklch(.291 .149 302.717);
...
<body
    class="flex flex-col lg:justify-center items-center bg-[#FDFDFC] dark:bg-[#0a0a0a] p-6 lg:p-8 min-h-screen text-[#1b1b18]">
    <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] lg:max-w-4xl text-sm">
        @if (Route::has('login'))
            <nav class="flex justify-end items-center gap-4">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="inline-block px-5 py-1.5 border border-[#19140035] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-[#1b1b18] dark:text-[#EDEDEC] text-sm leading-normal">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}"
    ...
    <div
        class="flex justify-center items-center opacity-100 starting:opacity-0 w-full transition-opacity duration-750 lg:grow">
        <main class="flex lg:flex-row flex-col-reverse w-full max-w-[335px] lg:max-w-4xl">
            <div
                class="flex-1 bg-white dark:bg-[#161615] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] p-6 lg:p-20 pb-12 lg:rounded-tl-lg rounded-bl-lg rounded-br-lg lg:rounded-br-none text-[13px] dark:text-[#EDEDEC] leading-[20px]">
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        class="before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute relative flex items-center gap-4 py-2 before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:border-l">
                        <span class="relative bg-white dark:bg-[#161615] py-1">
                            <span
                                class="flex justify-center items-center bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-full w-3.5 h-3.5">
                                <span class="bg-[#dbdbd7] dark:bg-[#3E3E3A] rounded-full w-1.5 h-1.5"></span>
                            </span>
                        </span>
                        <span>
                            Read the
                            <a href="https://laravel.com/docs" target="_blank"
                                class="inline-flex items-center space-x-1 ml-1 font-medium text-[#f53003] dark:text-[#FF4433] underline underline-offset-4">
                    ...
                    <li
                        class="before:top-0 before:bottom-1/2 before:left-[0.4rem] before:absolute relative flex items-center gap-4 py-2 before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:border-l">
                        <span class="relative bg-white dark:bg-[#161615] py-1">
                            <span
                                class="flex justify-center items-center bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-full w-3.5 h-3.5">
                                <span class="bg-[#dbdbd7] dark:bg-[#3E3E3A] rounded-full w-1.5 h-1.5"></span>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="https://cloud.laravel.com" target="_blank"
                            class="inline-block bg-[#1b1b18] hover:bg-black dark:bg-[#eeeeec] dark:hover:bg-white px-5 py-1.5 border dark:border-[#eeeeec] dark:hover:border-white border-black hover:border-black rounded-sm text-white dark:text-[#1C1C1A] text-sm leading-normal">
                            Deploy now
                        </a>
                    </li>
                </ul>
            ...
            <div
                class="relative bg-[#fff2f2] dark:bg-[#1D0002] -mb-px lg:mb-0 lg:-ml-px rounded-t-lg lg:rounded-t-none lg:rounded-r-lg w-full lg:w-[438px] aspect-[335/376] lg:aspect-auto overflow-hidden shrink-0">
                {{-- Laravel Logo --}}
                <svg class="opacity-100 starting:opacity-0 w-full max-w-none text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 starting:translate-y-6 duration-750"
                ...
                {{-- Light Mode 12 SVG --}}
                <svg class="dark:hidden relative -mt-[4.9rem] lg:-mt-[6.6rem] -ml-8 lg:ml-0 w-[448px] max-w-none"
                    viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g
                        class="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300">
                        <path
                ...
                {{-- Dark Mode 12 SVG --}}
                <svg class="hidden dark:block relative -mt-[4.9rem] lg:-mt-[6.6rem] -ml-8 lg:ml-0 w-[448px] max-w-none"
                    viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g
                        class="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300">
                        <path
                    ...
                    <g class="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300"
                ...
                <div
                    class="absolute inset-0 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-t-lg lg:rounded-t-none lg:rounded-r-lg">
                </div>
            </div>
        </main>
    </div>
